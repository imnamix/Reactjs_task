...
import { FaBookmark, FaSearch, FaShopify, FaBars, FaStar } from "react-icons/fa";
  ...
  return (
    <>
      <div className="container-fluid d-flex align-items-center position-relative poppins-regular">
        <nav className="navbar navbar-expand-lg navbar-light d-flex align-items-center justify-content-between fixed-top navconatiner" style={{ height: "80px" }}>
          <div className="w-100 container-fluid d-flex align-items-center justify-items-center">
            <img
              src={logo}
              alt="Logo"
              style={{
            ...
            <div className={`${isNavCollapsed ? "collapse" : ""} navbar-collapse p-5 p-lg-0`}>
              <div className="input-group mb-3 container-xxl d-none d-lg-flex mt-3 ">
                <input
                  type="text"
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item dropdown me-lg-2 w-100 mb-3 mb-lg-0">
                  <Dropdown>
                    <Dropdown.Toggle variant="secondary" id="navbarDropdown2" className="custom-dropdown-toggle">
                      <FaCompass className="btn-outline white-icon" />
                      <span className="title">Explore</span>
                    </Dropdown.Toggle>
                    <Dropdown.Menu style={{ marginTop: "25px", zIndex: 0, borderRadius: "0px" }}>
